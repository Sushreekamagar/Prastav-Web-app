...
router.put('/:id/accept',            protect, (req, res, next) => { req.body.action = 'accepted'; respondToTransaction(req, res, next); });
router.put('/:id/reject',            protect, (req, res, next) => { req.body.action = 'rejected'; respondToTransaction(req, res, next); });
